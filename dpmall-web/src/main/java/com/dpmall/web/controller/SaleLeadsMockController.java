 ...
 */
@Controller
@RequestMapping("/saleLeadsmock/")
public class SaleLeadsMockController {
    ...
    public Response getOnePageClosedSaleLeads(String distributorId,String distributeTimeBegin, String distributeTimeEnd,String storeId,String saleLeadId, String clientName,String clientTel,Integer startNum, Integer pageSize,String token){
        ...
        try{
    	    data = saleLeadsServiceMock.getOnePageClosedSaleLeads(distributorId, distributeTime, storeId, saleLeadId, clientName, clientTel,null, null,startNum, pageSize);
        } catch(Throwable e){
        	LOG.error(e.getMessage(),e);
    	}
